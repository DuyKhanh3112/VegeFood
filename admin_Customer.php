<html lang="en">
    ...
    <body class="goto-here">
        ...
        <form method="POST" action="./admin_Customer_Search.php">
            <table class="table">
                <tr>
                    <td><input class="form-control mr-sm-2" type="text" name="search" placeholder="Search"></td>
                    <td><button class="btn btn-success" type="submit">Search</button></td>
                </tr>
            </table>
        </form>
        <?php
        include './process/view_customer.php';
        ?>
