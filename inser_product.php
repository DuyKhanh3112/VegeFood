...
require_once './process/connectdb.php';
        ...
        $product = new Product("", "", "", "", "", "", "", "");
        $result=$product->countProduct($conn);
        ?>
<html lang="en">
    <head>
        ...
        <section class="ftco-section contact-section bg-light">
            <div class="container">
                <div class="media-body">
                    <form method="POST" action="./process_product/product_insert.php" enctype="multipart/form-data">
                        <table border="0" class="table">
                            <tbody>
                                <tr>
                                    <td>Product ID: </td>
                                    <td><input type="number" class="form-control" id="product_ID" name="product_ID" value="<?php echo $result +1; ?>" readonly></td>
                                </tr>
                                <tr>
                                    <td> Product Name: </td>
                                ...
                                <tr>
                                    <td>Unit: </td>
                                    <td><input type="text" class="form-control" id="product_Unit" name="product_Unit" required> </td>
                                </tr>
                                <tr>
                                    <td>Price: </td>
                                    <td><input type="number" class="form-control" id="product_Price" name="product_Price" required> </td>
                                </tr>
                                <tr>
                                    <td>Decription: </td>
                                    <td><textarea id="description" name="description" rows="5" cols="10" class="form-control" required></textarea></td>
                                </tr>
                                <tr>
                                    <td>Image: </td>
                                    <td><input type="file" class="form-control" id="product_Img" name="product_Img" required > </td>
                                </tr>
                                <tr>
                                    <td colspan="2" ><button type="submit" class="btn btn-primary">Insert</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
