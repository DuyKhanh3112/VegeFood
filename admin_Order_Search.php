        ...
        <table  class="table table-hover">
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    if ($row["order_ID"]==$_POST["search"]||$row["email"]==$_POST["search"]||$row["phone"]==$_POST["search"]||$row["address"]==$_POST["search"]){
                    ?>        
                    <tr>
                        ...
                        <td><a href="./admin_OrderDetails.php?id=<?php echo $row["order_ID"]; ?>" class="btn btn-primary">Order Details</a></td>
                    </tr>
                    <?php
                    }
                }
