<html lang="en">
    ...
    <body class="goto-here">
        ...
        require './process_order/order_data.php';
        require './process_product/product_data.php';
        $product= new Product("","","","","","","","");
        $order = new order("", "", "", "", "", "", "", "", "");
        $result = $order->showAllOrderDetails($conn);
        ?>
                ...
                while ($row = $result->fetch_assoc()) {
                    if ($row["order_ID"] == $_GET["id"]) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $row["product_ID"]. " - ". $product->ShowProductName($conn); ?></td>
